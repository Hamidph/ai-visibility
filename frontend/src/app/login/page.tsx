      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative flex flex-col justify-center px-12 xl:px-20">
          ...
          <p className="text-lg text-gray-400 mb-12 max-w-md">
            Join thousands of marketing teams using probabilistic AI analysis to optimize their brand visibility.
          </p>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-white font-medium">Monte Carlo Simulations</p>
                <p className="text-sm text-gray-500">Statistically significant visibility analysis</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-white font-medium">Multi-Provider Testing</p>
                <p className="text-sm text-gray-500">OpenAI, Anthropic, Perplexity & more</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Detailed reports and recommendations</p>
              </div>
            </div>
          </div>
        </div>
